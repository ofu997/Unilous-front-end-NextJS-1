...
// EXTERNAL MODULE: ./redux/reducers/posts.js
var posts = __webpack_require__("6Ysq");

// EXTERNAL MODULE: ./redux/reducers/alertNotif.js
var alertNotif = __webpack_require__("iD+C");

// EXTERNAL MODULE: ./redux/reducers/stretchLayout.js
var stretchLayout = __webpack_require__("gH2n");

// EXTERNAL MODULE: ./redux/reducers/eventSearch.js
var eventSearch = __webpack_require__("2E1m");
...
const reducers = Object(external_redux_["combineReducers"])({
  ...
  currentUser: currentUser["a" /* default */],
  posts: posts["b" /* default */],
  alertNotif: alertNotif["a" /* default */],
  stretchLayout: stretchLayout["a" /* default */],
  eventSearch: eventSearch["a" /* default */]
});

const store_store = () => Object(external_redux_["createStore"])(reducers, bindMiddleware([external_redux_thunk_default.a]));
...
// EXTERNAL MODULE: ./styles/notifs.css
var notifs = __webpack_require__("UpMI");
...
/* harmony default export */ var _app = __webpack_exports__["default"] = (Object(external_redux_["compose"])(external_next_redux_wrapper_default()(redux_store), Object(apollo["b" /* default */])({
  ssr: true
}))(MyApp));
